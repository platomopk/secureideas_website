  ...
  indenting, security consultancy and security equipment. ">
    ...
    <script>
        $(document).ready(function () {
            $("#securityequipmentid").addClass("navactive");
...
<body style="overflow-x:hidden">
                        ...
                        <div class="outer">
                            <div class="middle">
                                <div class="slidercontent">
                                    <h2>security <br>equipment</h2><br>
                                    <p>
                                    Our priority is understanding the needs and <br> requirements 
                                    of our clients and ensure we comply to <br> international standards of 
                                    quality and delivery of <br> our products and services. <br> 
                                    We provide a vast array of products for your <br> Security needs, from security <br>
                                    of your premises to commercial security <br> equipment and complete security solutions. <br>
    ...
    <section id="newclipart">
            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="clipartname text-center">
                            Surveillance Systems <br>  &amp; CCTV Cameras
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="clipart text-center">
        ...
        <div class="row" id="descrow">
            <div class="col-md-10 col-md-offset-1">
                <div class="row">
                    <div class="col-md-4 desccol" id="gded">
                    ...
                    <div class="col-md-4 desccol" id="ped">
                        <div class="clipartdesc ">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Nesciunt praesentium sit, nihil eaque esse pariatur sapiente dolorum eum nam expedita mollitia soluta et, iste, fuga ratione distinctio alias magnam perferendis?
                    ...
                    <div class="col-md-4 desccol" id="ced">
                        <div class="clipartdesc ">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Nesciunt praesentium sit, nihil eaque esse pariatur sapiente dolorum eum nam expedita mollitia soluta et, iste, fuga ratione distinctio alias magnam perferendis?
